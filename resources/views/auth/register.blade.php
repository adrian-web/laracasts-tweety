            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-6">
                    ...
                    <input id="username" type="text" name="username" value="{{ old('username') }}" required
                        autocomplete="username" class="border border-gray-400 p-2 w-full">
                ...
                <div class="mb-6">
                    <label for="description"
                        class="block mb-2 uppercase font-bold text-xs text-gray-700">{{ __('Description') }}</label>


                    <textarea name="description" id="description" class="border border-gray-400 p-2 w-full" required
                ...
                <div class="">
                    ...
                    <button type="submit" class="mr-2 bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500">
                        {{ __('Register') }}
                    </button>
